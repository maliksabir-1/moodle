...
$string['regenerateall'] = 'Regenerate all issued certificates';
$string['regeneratefileconfirmallusers'] = '<p>Are you sure you want to regenerate all certificates issued to users?</br>This action cannot be undone.</p>';
$string['regeneratefileconfirmselectedusers'] = '<p>Are you sure you want to regenerate all certificates issued to the selected users?</br>This action cannot be undone.</p>';
$string['regeneratefileconfirmsingleuser'] = '<p>Are you sure you want to regenerate the certificate issued to this user?</br>This action cannot be undone.</p>';
$string['regenerateissuedcertificates'] = 'Regenerate issued certificates';
$string['regenerateissuefile'] = 'Regenerate issued certificate';
...
$string['sendnotificationaffectedusers'] = 'Also send a notification message to all affected users';
$string['sendnotificationaffectedusers_help'] = 'The message that will be sent is the same message that was sent to users when they got the certificate for the first time.';
$string['sendnotificationsingleuser'] = 'Also send a notification message to the user';
...
$string['saveaspdf'] = 'Save as PDF (Print)';
