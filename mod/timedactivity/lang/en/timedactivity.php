...
$string['allowedattempts_help'] = 'Set the maximum number of attempts a student is allowed to open and complete this activity. Set to 0 for unlimited attempts.';
$string['error_maxattemptsreached'] = 'You have reached the maximum number of allowed attempts ({$a}) to complete this activity.';
$string['quizpopuptimes'] = 'Interactive Quiz Popup Times';
$string['maxquizattempts'] = 'Maximum quiz attempts';
$string['maxquizattempts_help'] = 'Set the maximum number of times a student is allowed to answer/attempt each interactive quiz popup question. Set to 0 for unlimited.';